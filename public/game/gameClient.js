var faceraceClient = (function() {
    ...
    var startGame = function(url, controls, graphics, config) {
        var simulator = facerace.Simulator(20, {
            isClient: true,
            logStates: false
        }),
        ...
        emit('join', {
            name: 'blake',
            face: '/images/faces/blake.png'
        });

        socket.on('update', simulator.receiveMessage);
...
//         });
        ...
        var sendControls = function() {
            ...
            simulator.worldControls.addEvent(simulator.world.state.predictStep + 1, {
                type: 'controls',
                id: playerID,
                controls: controls
            });
            ...
            _.each(controlList, function(control) {
                oldControls[control] = controls[control];
            });
            //}
        };
